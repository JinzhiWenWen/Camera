    ...
    <div id="Participant">
        ...
        <div class="Organizer_role">
            <div class="Organizer_role_bottom">
                <p>申请说明</p>
                <textarea name="" id="" cols="30" rows="10" class="text" placeholder="如：个人落地执行能力突出......" v-model="Apply.applyInfo">
                </textarea>
            </div>
        </div>
        <div class="Organizer_role_radio"> 
             <div class="role_radio_div">
                ...
                <div class="role_div_bottom">
                    <ul>
                        <li>报名参加此次活动需满足一下条件:</li>
                        <li>xxxxx</li>
                        <li>请将您的优势填写到申请说明中</li>
                    </ul>
                </div>
             </div>
        </div>
...
<script>
    export default {
        ...
        methods:{
            ...
            Apply_fn(){
                this.$http.post('http://192.168.1.109:3000/v1/activity/enroll/participator',this.Apply).then(res=>{
                    console.log(res)
                    this.$router.go(-1)
                })
